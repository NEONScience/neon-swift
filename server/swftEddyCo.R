    ...
    swft_ec_fast_plot = shiny::eventReactive(input$swft_ec_fast_actionButton,{
      ...
      message("Data pull Finished")
        ...
        if(nrow(li7200.data) > 0){
          ...
          li7200.data = data.table::data.table()
        }
        ...
        if(nrow(l2130.h2o.data) > 0){
          ...
          l2130.h2o.data = data.table::data.table()
        }
        ...
        if(input$swft_EddyCo_data_type == "G2131"){
          if(input$swft_EddyCo_sub_data_type_G2131 == "CO2"){
            ...
            swft.plot = ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
              ...
              labs(x = "", y = "Concentration (ppm)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])) +
              theme(strip.text.x = element_text(size = 14), text = element_text(color = "white", face = "bold", size = 20)) + guides(colour = guide_legend(override.aes = list(size=5, alpha = 1)))
          ...
          if(input$swft_EddyCo_sub_data_type_G2131 == "H2O"){
            ...
            swft.plot = ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
              ...
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              labs(x = "", y = "", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])) +
          ...
          if(input$swft_EddyCo_sub_data_type_G2131 == "Isotopes"){
            ...
            swft.plot = ggplot(data = swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
              ...
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              labs(x = "", y = "Concentration", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_G2131), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2])) +
              theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) + guides(colour = guide_legend(override.aes = list(size=5, alpha = 1)))
        ...
        if(input$swft_EddyCo_data_type == "L2130"){
          if(input$swft_EddyCo_sub_data_type_L2130 %in% c("Isotope - 2H", "Isotope - 18O")){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = SampleLevel)) +
              ...
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              theme(strip.text.x = element_text(size = 12), text = element_text(color = "white", face = "bold", size = 20)) +
              labs(x = "", y = "per mil", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_L2130), 
        ...
        if(input$swft_EddyCo_data_type == "Li7200"){
          if(input$swft_EddyCo_sub_data_type_Li7200 == "CO2"){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
              ...
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
              labs(x = "", y = "Concentration (ppm)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li7200), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2]))+
              facet_wrap(~`Stream Name`)
          }
          if(input$swft_EddyCo_sub_data_type_Li7200 == "H2O"){
          ...
          if(input$swft_EddyCo_sub_data_type_Li7200 == "Flow"){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
              ...
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
              labs(x = "", y = "", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li7200), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2]))+
              facet_wrap(~`Stream Name`)
          }
          if(input$swft_EddyCo_sub_data_type_Li7200 == "Signal Strength"){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double, color = `Stream Name`)) +
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = 95, ymax = 102, alpha = 0.25, fill = "#00cc00")+
              geom_point(alpha = .8) +
              ...
              labs(x = "", y = "", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_Li7200), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2]))+
              facet_wrap(~`Stream Name`)+ guides(colour = guide_legend(override.aes = list(size=4, alpha = 1)))
          }
          if(input$swft_EddyCo_sub_data_type_Li7200 == "Cell Temp"){
            message(paste0("Plot: ", input$swft_EddyCo_data_type, " - ", input$swft_EddyCo_sub_data_type_Li7200, " for ", input$swft_EddyCo_site, " from ", input$swft_EddyCo_date_range[1], " - ", input$swft_EddyCo_date_range[2]))
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = temp_diff)) +
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = 8,    ymax = Inf, alpha = 0.4, fill = "red")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = 6,    ymax =   8, alpha = 0.4, fill = "#ff8c00")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = 2,    ymax =   6, alpha = 0.4, fill = "#00cc00")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = .2,   ymax =   2, alpha = 0.4, fill = "#ff8c00")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = -Inf, ymax =  .2, alpha = 0.4, fill = "red")+
              geom_point(alpha = .8, color = "cyan") +
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              scale_y_continuous(breaks = scales::pretty_breaks(n = 6), sec.axis = dup_axis(name = "")) +
              theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
          ...
          if(input$swft_EddyCo_sub_data_type_Li7200 == "Pressure Differential"){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y = readout_val_double)) +
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = -3, ymax = -.7, alpha = 0.4, fill = "#00cc00")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = -5, ymax = -3, alpha = 0.4, fill = "#ff8c00")+
              annotate("rect", xmin = plot.min, xmax = plot.max, ymin = -10, ymax = -5, alpha = 0.4, fill = "red")+
        ...
        if(input$swft_EddyCo_data_type == "CO2"){
          ...
          swft.plot <- ggplot(swft.data.out, aes(x=readout_time, y= readout_val_double, color = `Stream Name`))+
            ...
            labs(title = paste0(swft.data.out$SiteID[1], ": CO2 2-minute point data"),
                 x = "", y = "CO2 (ppm)",
                 color = "Sensor") +
            theme(text = element_text(color = "white", face = "bold", size = 20)) + guides(colour = guide_legend(override.aes = list(size=5, alpha = 1)))  # Option to angle the facet grid y panel text
        }
        ...
        if(input$swft_EddyCo_data_type == "HMP155"){
          if(input$swft_EddyCo_sub_data_type_HMP155 == "Relative Humidity"){
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y= readout_val_double))+
              ...
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
              labs(x = "", y = "%", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_HMP155), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2]))
          }
          if(input$swft_EddyCo_sub_data_type_HMP155 == "Temperature"){
            message(paste0("Plot: ", input$swft_EddyCo_data_type, " - ", input$swft_EddyCo_sub_data_type_HMP155, " for ", input$swft_EddyCo_site, " from ", input$swft_EddyCo_date_range[1], " - ", input$swft_EddyCo_date_range[2]))
            ...
            swft.plot = ggplot(swft.data.out, aes(x = readout_time, y= readout_val_double))+
              ...
              scale_x_datetime(breaks = scales::pretty_breaks(n = 10), date_labels = "%Y-%m-%d") +
              theme(strip.text.x = element_text(size = 12), axis.text.x = element_text(angle = 270), text = element_text(color = "white", face = "bold", size = 20)) +
              labs(x = "", y = "Temperature (C)", title = paste0(input$swft_EddyCo_site, " - ", input$swft_EddyCo_data_type, " ", input$swft_EddyCo_sub_data_type_HMP155), 
                   subtitle = paste0(input$swft_EddyCo_date_range[1], " to ", input$swft_EddyCo_date_range[2]))
          }
          if(input$swft_EddyCo_sub_data_type_HMP155 == "Dew Point"){
            message(paste0("Plot: ", input$swft_EddyCo_data_type, " - ", input$swft_EddyCo_sub_data_type_HMP155, " for ", input$swft_EddyCo_site, " from ", input$swft_EddyCo_date_range[1], " - ", input$swft_EddyCo_date_range[2]))
